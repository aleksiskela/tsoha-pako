...
CREATE TABLE events (id SERIAL PRIMARY KEY, name TEXT, description TEXT, creator_id INTEGER REFERENCES users, visible BOOLEAN DEFAULT TRUE, datetime TIMESTAMP, location TEXT DEFAULT '-');
